...
<body class="bg-light">
	...
	<div class="container">
		<main>
			...
			<?php
			$harga = array(
				'Nasi Goreng Spesial + Kenangan' => 25000 ,
				'Sop Buntut Naga Night Furry' => 150000 ,
				'Nasi Goreng Spesial + Kenangan' => 25000 ,
				'Nasi Goreng Spesial + Kenangan' => 25000 ,
				'Nasi Goreng Spesial + Kenangan' => 25000 ,
				'Nasi Goreng Spesial + Kenangan' => 25000  );
			...
			$data = array(
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text"><?= $data['menu']; ?> (Jumlah : <?= $data['jumlah']; ?>)</p>
						<a href="#" class="btn btn-primary"><?php if ($data['menu'] == $harga) {
							echo "test";
							# code...
						} ?></a>
					</div>
